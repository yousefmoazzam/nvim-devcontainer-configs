return {
  ...
  config = function()
    ...
    local handlers =  {
      ["textDocument/hover"] =  vim.lsp.with(vim.lsp.handlers.hover, {border = vim.g.border_config}),
      ["textDocument/signatureHelp"] =  vim.lsp.with(vim.lsp.handlers.signature_help, {border = vim.g.border_config }),
    }
    ...
    require('lspconfig.ui.windows').default_options = { border = vim.g.border_config }
